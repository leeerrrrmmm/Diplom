...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "accept": MessageLookupByLibrary.simpleMessage("Підтвердити налаштування"),
    "antonym": MessageLookupByLibrary.simpleMessage("Антоніми"),
    "author": MessageLookupByLibrary.simpleMessage("Автор"),
    "choose_the_cur_filter": MessageLookupByLibrary.simpleMessage(
      "Оберіть потрібні фільтри та введіть будь-який запит",
    ),
    ...
    "select_lang": MessageLookupByLibrary.simpleMessage("Оберіть мову"),
